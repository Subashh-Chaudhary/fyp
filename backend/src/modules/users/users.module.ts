...
@Module({
  imports: [TypeOrmModule.forFeature([Users]), ExpertModule],
  controllers: [UsersController],
  providers: [UsersService, UsersRepository, SocialAuthService, AdminSeeder],
  exports: [UsersRepository, UsersService, SocialAuthService, AdminSeeder], // Export AdminSeeder so DatabaseService can use it
})
